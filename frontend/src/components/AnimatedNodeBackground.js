...
import './AnimatedNodeBackground.css'; // Nous créerons ce fichier CSS juste après

const AnimatedNodeBackground = () => {
    ...
    useEffect(() => {
        ...
        function initHeader() {
            ...
            for (let i in points) {
                let c = new Circle(points[i], 2 + Math.random() * 2, 'rgba(92,83,234,0.3)');
                points[i].circle = c;
            }
        }
    ...
    return (
        <div ref={containerRef} className="animated-bg-header">
